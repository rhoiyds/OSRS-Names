...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, io.github.jhipster.application.domain.Listing.class.getName() + ".offers");
            createCache(cm, io.github.jhipster.application.domain.Offer.class.getName());
            createCache(cm, io.github.jhipster.application.domain.Offer.class.getName() + ".comments");
            createCache(cm, io.github.jhipster.application.domain.Trade.class.getName());
            createCache(cm, io.github.jhipster.application.domain.Trade.class.getName() + ".comments");
            ...
            createCache(cm, io.github.jhipster.application.domain.MiddlemanRequest.class.getName() + ".comments");
