...
public class ListingResourceIT {
    ...
    public void setup() {
        ...
        final ListingResource listingResource = new ListingResource(listingService, listingQueryService);
    ...
    public void getAllListingsWithEagerRelationshipsIsEnabled() throws Exception {
        ListingResource listingResource = new ListingResource(listingServiceMock, listingQueryService);
